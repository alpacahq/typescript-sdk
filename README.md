...
![version](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Falpacahq%2Ftypescript-sdk%2Fmain%2F.github%2Fbadges%2Fversion.json&color=FF33A0&style=flat)
...
| ------------------------------------------------------ | -------- | ------------------ |
| `/v2/account`                                          | `GET`    | :green_check_mark: |
| `/v2/orders`                                           | `POST`   | :green_check_mark: |
| `/v2/orders`                                           | `GET`    | :green_check_mark: |
| `/v2/orders/{orderId}`                                 | `DELETE` | :green_check_mark: |
| `/v2/orders/{orderId}`                                 | `PATCH`  | :green_check_mark: |
| `/v2/positions`                                        | `GET`    | :green_check_mark: |
| `/v2/positions/{symbol_or_asset_id}`                   | `DELETE` | :green_check_mark: |
| `/v2/positions/{symbol_or_contract_id}/exercise`       | `POST`   | :green_check_mark: |
| `/v2/account/portfolio/history`                        | `GET`    | :green_check_mark: |
| `/v2/watchlists`                                       | `GET`    | :green_check_mark: |
| `/v2/watchlists`                                       | `POST`   | :green_check_mark: |
| `/v2/watchlists/{watchlist_id}`                        | `PUT`    | :green_check_mark: |
| `/v2/watchlists/{watchlist_id}`                        | `DELETE` | :green_check_mark: |
| `/v2/watchlists/{watchlist_id}/{symbol}`               | `POST`   | :green_check_mark: |
| `/v2/watchlists:by_name`                               | `GET`    | :green_check_mark: |
| `/v2/watchlists:by_name`                               | `PUT`    | :green_check_mark: |
| `/v2/watchlists:by_name`                               | `POST`   | :green_check_mark: |
| `/v2/watchlists:by_name`                               | `DELETE` | :green_check_mark: |
| `/v2/watchlists/{watchlistId}/{symbol}`                | `DELETE` | :green_check_mark: |
| `/v2/account/configurations`                           | `GET`    | :green_check_mark: |
| `/v2/account/configurations`                           | `PATCH`  | :green_check_mark: |
| `/v2/account/activities/{activityType}`                | `GET`    | :green_check_mark: |
| `/v2/calendar`                                         | `GET`    | :green_check_mark: |
| `/v2/clock`                                            | `GET`    | :green_check_mark: |
| `/v2/assets`                                           | `GET`    | :green_check_mark: |
| `/v2/assets/{symbolOrAssetId}`                         | `GET`    | :green_check_mark: |
| `/v2/options/contracts/{symbolOrId}`                   | `GET`    | :green_check_mark: |
| `/v2/corporate_actions/announcements/{announcementId}` | `GET`    | :green_check_mark: |
| `/v2/wallets`                                          | `GET`    | :green_check_mark: |
| `/v2/wallets/transfers`                                | `POST`   | :green_check_mark: |
| `/v2/wallets/transfers/{transferId}`                   | `GET`    | :green_check_mark: |
| `/v2/wallets/whitelists`                               | `GET`    | :green_check_mark: |
| `/v2/wallets/whitelists`                               | `POST`   | :green_check_mark: |
| `/v2/wallets/whitelists/{whitelistedAddressId}`        | `DELETE` | :green_check_mark: |
| `/v2/wallets/fees/estimate`                            | `GET`    | :green_check_mark: |
